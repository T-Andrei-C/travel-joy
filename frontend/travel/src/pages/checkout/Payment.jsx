            ...
            <div className="col-12 row d-flex justify-content-center m-0 p-0">
                <div className="col-xl-5 col-lg-5 col-md-6 col-sm-10 col-11 mt-sm-3 mt-md-0 mt-lg-0 mt-xl-0 mt-3">
                    <AddressForm data={personalInfo} dataCallback={setPersonalInfo} user={authUser}
                                 travelPackage={currentTravelPackage} room={currentRoom} discount={availableDiscount}/>
                </div>
                <div className="col-xl-5 col-lg-5 col-md-5 col-sm-10 col-12">
                    <ReviewOrder checkIn={checkIn} checkOut={checkOut} city={city} housingName={housingName}
                                 room={currentRoom} travelPackage={currentTravelPackage} discount={availableDiscount}/>
                </div>
            </div>
            ...
            <div
                ...
                {clientSecret && stripePromise && (
                    <Elements stripe={stripePromise} options={{clientSecret}}>
                        <CheckoutForm reservationData={personalInfo} travelType={"none"} roomId={room}
