...
import {
    getAccommodationsByCityName,
    getAccommodationsPerPage,
...
const Accommodations = () => {
    ...
    return (
        <>
            <div className="h-100 text-center pt-5 m-0 p-0">
            ...
            <div className="d-flex justify-content-center">
                <TravelSearch goingTo={destination} checkIn={checkIn} checkOut={checkOut}
                              numberOfPersons={numberOfPersons} type={"accommodations"}/>
            </div>
            ...
            {
                destination !== undefined && checkIn !== undefined ?
                    <Pagination key="1" travelBundles={accommodationsSearch}
                                link={`accommodations/${destination}/${checkIn}/${checkOut}/${numberOfPersons}/${accommodationsByCity.size}`}
                                numberOfPage={accommodationsSearch.number}/>
                    : destination !== undefined ?
                        <Pagination key="2" travelBundles={accommodationsByCity}
                                    link={`accommodations/${destination}/${accommodationsByCity.size}`}
                                    numberOfPage={accommodationsByCity.number}/>
                        :
