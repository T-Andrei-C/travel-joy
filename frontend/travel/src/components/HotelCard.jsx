                        ...
                        <div className="card-body">
                            ...
                            <div className="row">
                                ...
                                <div className="my-auto col-xl-4 col-12 ">
                                    <a onClick={checkSearchData} className="btn btn-success float-md-end mb-3 col-12" data-bs-toggle={city && checkIn && checkOut && numberOfPersons ? "" : "modal"} data-bs-target="#exampleModal">
                                        View Details
                                    </a>
                                    <Popup/>
                                </div>
